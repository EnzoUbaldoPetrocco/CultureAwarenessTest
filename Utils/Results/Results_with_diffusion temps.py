...
class ResAcquisitionClass:
    ...
    def get_cm_structure(self, basePath):
        ...
        percents = [0.05, 0.2]
        augments = [0, 1]
        g_augments = {"0.05": np.logspace(-3, -1, 3), "0.2": np.logspace(-3, -1, 3)}
        adversary = [0, 1]
        epsilons = {"0.05":np.logspace(-3, -1, 3), "0.2":np.logspace(-3, -1, 3)}  # [0.0001, 0.0002, 0.0005, 0.001, 0.002, 0.005, 0.01, 0.02, 0.05, 0.1, 0.2]    
        imbalanceds = [0, 1]
        diffusion = [0,1]
        g_diffusion = [0.001]
