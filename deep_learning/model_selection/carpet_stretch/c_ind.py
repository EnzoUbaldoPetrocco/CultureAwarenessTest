...
for i in range(0,len(space)):
    j = space[i]
    cc = ClassificatorClass(0, 0, paths,batch_size=4, fileName=folders[i] + '/c_ind.csv', verbose = 1, validation_split=0.3, epochs=7, learning_rate=4e-4, percent=j, times=1)
